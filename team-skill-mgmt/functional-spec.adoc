...
=== Scenario TEAMSKILL_001: Browse teams
....
...
=== Scenario TEAMSKILL_002: Display skill requirements
....
...
=== Scenario TEAMSKILL_003: Edit Team
....
...
=== Scenario TEAMSKILL_004: Display skill radar
....
Given I am logged as a XXXX on the selection screen
When I select a team
