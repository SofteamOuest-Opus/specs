...
Les deux solutions VPS SSD 3 et SP-64 sont assez similaires. Nous préférons la solution à base de VPS qui nous permettra de tester différentes architectures Kubernetes (1 master, plusieurs masters).
